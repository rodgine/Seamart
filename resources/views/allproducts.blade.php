            ...
            <div class="container-fluid">
                <div class="d-flex align-items-center justify-content-between mb-4 mt-4 flex-wrap">
                    <div class="d-flex align-items-center">
                        <h1 class="mb-0 fw-bold new-arrival">ALL PRODUCTS</h1>
                        &nbsp;&nbsp;&nbsp;
                    ...
                    <div class="d-flex align-items-center mt-2 mt-md-0">
                        ...
                        <div class="dropdown ms-3">
                            ...
                            <ul class="dropdown-menu dropdown-menu-end" aria-labelledby="sortDropdown">
                                <li><a class="dropdown-item {{ request('sort') == 'popularity' ? 'active' : '' }}"
                                        href="{{ url('all-products?sort=popularity') }}">Sort by Popularity</a></li>
                                <li><a class="dropdown-item {{ request('sort') == 'latest' ? 'active' : '' }}"
                                        href="{{ url('all-products?sort=latest') }}">Sort by Latest</a></li>
                                <li><a class="dropdown-item {{ request('sort') == 'price_asc' ? 'active' : '' }}"
                                        href="{{ url('all-products?sort=price_asc') }}">Price (Low to High)</a></li>
                                <li><a class="dropdown-item {{ request('sort') == 'price_desc' ? 'active' : '' }}"
                                        href="{{ url('all-products?sort=price_desc') }}">Price (High to Low)</a></li>
                            </ul>
                        </div>
                    </div>
                </div>
                        ...
                        <div class="col-lg-3 col-md-4 col-sm-6 mb-4">
                            <div class="collection-items position-relative">
                                @if ($product->stock > 0)
                                    ...
                                    @else
                                        <div class="d-block position-relative not-clickable" style="cursor: not-allowed;">
                                @endif
                                ...
                                @if ($product->stock == 0)
                                    <img src="{{ asset('admin-assets/assets/images/logos/sold.png') }}" alt="Sold Out"
                                        class="position-absolute top-50 start-50 translate-middle sold-overlay sold-trigger"
                                        style="max-width: 100%;">
                                @endif
